...
public class ExcelExporter {
        ...
        public static void export(TestDesignData data)
                ...
                Row scenarioHeader = scenarioSheet.createRow(0);
                ...
                for (String scenario : data.getScenarios()) {

                        Row row = scenarioSheet.createRow(rowNum++);
                ...
                Sheet positiveSheet = workbook.createSheet("Positive Cases");

                Row positiveHeader = positiveSheet.createRow(0);
                ...
                for (String positive : data.getPositiveCases()) {

                        Row row = positiveSheet.createRow(rowNum++);
                ...
                Sheet negativeSheet = workbook.createSheet("Negative Cases");
                ...
                for (String negative : data.getNegativeCases()) {

                        Row row = negativeSheet.createRow(rowNum++);
                ...
                Sheet edgeSheet = workbook.createSheet("Edge Cases");

                Row edgeHeader = edgeSheet.createRow(0);
                ...
                for (String edge : data.getEdgeCases()) {

                        Row row = edgeSheet.createRow(rowNum++);
                ...
                Sheet automationSheet = workbook.createSheet(
                                "Automation Candidates");

                Row automationHeader = automationSheet.createRow(0);
                ...
                for (String candidate : data.getAutomationCandidates()) {

                        Row row = automationSheet.createRow(rowNum++);
                ...
                Sheet dataSheet = workbook.createSheet("Test Data");
                ...
                for (String testData : data.getTestData()) {
